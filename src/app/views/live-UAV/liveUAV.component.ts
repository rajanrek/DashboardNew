...
@Component({
  templateUrl: 'liveUAV.component.html',
  styleUrls	: ['./liveUAV.component.scss']
})
export class LiveUAVComponent {
  ...
  liveStreaming() {
     var element = document.getElementById("liveUat");
     element.classList.toggle("live-streaming-block");
  }
  
  streetView() {
     var element = document.getElementById("liveUat");
     element.classList.toggle("street-view-block");
  }
  
  liveTop() {
     var element = document.getElementById("liveUat-top");
     element.classList.toggle("show-tp");
  }
  
  streetTop() {
     var element = document.getElementById("street-top");
     element.classList.toggle("show-tp");
  }
}
